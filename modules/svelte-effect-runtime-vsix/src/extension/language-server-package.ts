...
/**
 * Creates the minimal npm manifest used to install the paired language-server
 * package for this extension release.
 *
 * @example
 * ```ts
 ...
 *
 * @since 3.4.3
 * @returns An npm package manifest with an exact language-server dependency.
 */
