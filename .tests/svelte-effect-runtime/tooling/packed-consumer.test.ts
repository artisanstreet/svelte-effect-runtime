import { copyFile, cp, readFile, stat } from "node:fs/promises";
...
const phases = ["sync", "check:types", "check:ser"] as const;

test("packed SvelteKit consumer completes named sync, type, and SER Vite checks", async () => {
