...
- [x] B. SvelteKit tarball repro for client/runtime transform behavior.
...
- Client transform tarball repro covered Vite plugin integration, script effect
  success/failure, top-level await rejection, markup plain/event/
